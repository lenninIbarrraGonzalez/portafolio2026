...
function FlipCard({ children, backContent }: { children: React.ReactNode; backContent: React.ReactNode }) {
  return (
    <div
      className="hidden md:block h-[300px] group"
...
export function Experience() {
  ...
  return (
    <section id="experience" className="py-8 sm:py-10 lg:py-14 bg-secondary/30" ref={containerRef}>
