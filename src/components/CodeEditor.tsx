...
const codeVariations: { code: CodeSegment[]; filename: string }[] = [
  // Variation 1: Companies/Experience
  {
    ...
    code: [
      { text: '// +10 years of experience', color: 'text-gray-400' },
      { text: '\n', color: 'text-gray-300' },
  ...
  // Variation 3: Education with while loop
  {
    ...
    code: [
      { text: '// Formal Education', color: 'text-gray-400' },
      { text: '\n', color: 'text-gray-300' },
      { text: 'const ', color: 'text-purple-400' },
      ...
      { text: '\n];', color: 'text-gray-300' },
      { text: '\n\n', color: 'text-gray-300' },
      { text: '// Never stop learning', color: 'text-gray-400' },
      { text: '\n', color: 'text-gray-300' },
...
export function CodeEditor({ isInView, className = '' }: CodeEditorProps) {
  ...
  return (
    <div className={`w-full ${className}`} data-testid="code-editor">
      {/* Editor window */}
      <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-700/50 bg-[#1e1e1e]" data-testid="code-editor-window">
        {/* Title bar */}
        <div className="bg-[#323233] px-4 py-3 flex items-center gap-2" data-testid="editor-titlebar">
          <div className="flex gap-2">
            <div className="w-3 h-3 rounded-full bg-[#ff5f56] hover:bg-[#ff5f56]/80 transition-colors" data-testid="traffic-light-red" />
            <div className="w-3 h-3 rounded-full bg-[#ffbd2e] hover:bg-[#ffbd2e]/80 transition-colors" data-testid="traffic-light-yellow" />
            <div className="w-3 h-3 rounded-full bg-[#27ca3f] hover:bg-[#27ca3f]/80 transition-colors" data-testid="traffic-light-green" />
          </div>
        ...
        <div className="p-4 sm:p-6 font-mono text-sm sm:text-base min-h-[180px] sm:min-h-[200px]">
          <div className="flex">
            {/* Line numbers */}
            <div className="text-gray-600 text-right pr-4 select-none leading-relaxed border-r border-gray-700/50 mr-4" data-testid="line-numbers">
            ...
            <div className="flex-1 leading-relaxed whitespace-pre overflow-x-auto">
              ...
              <motion.span
                ...
                className={cn(
                  'inline-block w-2 h-5 ml-0.5 align-middle',
        ...
        <div className="bg-[#252526] border-t border-gray-700/50 px-2 flex items-center">
          <div className="flex text-xs">
            <span className="px-3 py-1.5 text-gray-400">{t('tabs.problems')}</span>
            <span className="px-3 py-1.5 text-gray-400">{t('tabs.output')}</span>
            <span className="px-3 py-1.5 text-white border-b-2 border-[#d97757]">{t('tabs.terminal')}</span>
          </div>
        </div>
        ...
        <div className="bg-[#1e1e1e] border-t border-gray-700/50 p-3 font-mono text-xs sm:text-sm">
          ...
          <div className="border border-dashed border-[#d97757] rounded mx-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-3">
              ...
              <div className="text-center">
                <p className="text-gray-200 text-sm mb-2">{t('welcomeBack')}</p>
                <ClaudeMascot />
                <div className="text-xs text-gray-400 mt-2 space-y-0.5">
                  ...
                  <p className="text-gray-400">ing.lenninibarra@gmail.com</p>
                  <p className="text-gray-400">~/Documentos/cv/portafolio2026</p>
                </div>
              </div>
              ...
              <div className="border-t md:border-t-0 md:border-l border-gray-700/50 pt-3 md:pt-0 md:pl-4">
                <div className="mb-3">
                  <p className="text-[#5fd7d7] text-xs font-semibold mb-1">
                    {t('tipsTitle')}
                  </p>
          ...
          <div className="text-gray-400 text-xs mt-2 ml-2">
            <span className="text-gray-600">❯</span> {t('commandSuggestion', { filename })}
          </div>
        </div>
      </div>
    </div>
