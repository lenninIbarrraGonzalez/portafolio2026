...
export const PERSONAL_INFO = {
  ...
  website: 'https://lenninibarra.com',
  cvPath: '/docs/Front-End-Architect-React2026-v1.pdf',
} as const;
...
// LinkedIn URL (for contact button in Hero)
export const LINKEDIN_URL = 'https://www.linkedin.com/in/lennin-geovanny-ibarra/';
